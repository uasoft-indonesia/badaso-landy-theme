     ...
     <div class="container lg:mx-auto max-w-[1280px] w-full pb-20 px-4">
         <div class="flex justify-center mb-5 pt-15 lg:pt-28">
             <div class="rounded-full border-2 border-blue-700 p-1 px-8">
                 <span class="font-semibold text-sm lg:text-base text-blue-700" x-text="video.title.data">Our Intro
                     Video</span>
             </div>
         </div>
         <div class="flex justify-center mb-5">
             <span class="text-3xl lg:text-4xl font-bold text-center" x-text="video.subtitle.data">Watch Our Promo
                 Video</span>
         </div>
         ...
         <div class="flex justify-center mb-10">
             <div class="lg:w-[900px] lg:h-[450px] relative">
                 <img src="https://demo.ayroui.com/templates/business-template/assets/images/video/video-bg.png" :src="video.bgvideo.data"
                     class="rounded-lg w-full object-cover" alt="Shoes" />
                 <div class="absolute top-1/2 left-1/2"><a :href="video.url.data.url">
                         <button
                             class="btn btn-outline border-none btn-circle text-blue-700  bg-white   text-sm p-3.5 hover:bg-blue-700 hover:border-white">
