     ...
     <div class="container mx-auto max-w-[1280px] grid-cols-1 divide-y px-4  w-full pb-24">
         <div class="grid lg:grid-cols-12 pt-10 pr-4 gap-4 ">
             <div class="lg:col-span-6 self-center">
                 ...
                 <p class="text-4xl  lg:text-[44px] font-bold text-white leading-[56px]" x-text="landingpage.title.data">
                     Corporate & Business Site Template By Ayro
                     UI.</p>
                 <div class="mt-8">
                     <span class="text-left font-normal text-slate-300 text-sm lg:text-base"
                 ...
                 <div class="mt-8">
                     <div class="flex space-x-4">
                         <div class="grid lg:grid-cols-2 gap-2">
                             ...
                             <div class="flex mt-2 mb-2 lg:mt-0 lg:mb-0">
                                 <div>
                                     <a href="https://www.youtube.com/watch?v=NX_NW6bt6_s" :href="landingpage.video.data.url" class="glightbox"><button
                                             ...
                                             <svg class="w-5 h-5" fill="currentColor" xmlns="http://www.w3.org/2000/svg"
                                                 ...
                                                 id="Capa_1" x="0px" y="0px" viewBox="0 0 60 60"
