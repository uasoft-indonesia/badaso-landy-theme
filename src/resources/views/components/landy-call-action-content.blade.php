  <div class="bg-blue-700">
        <div class="container lg:mx-auto max-w-[1280px] w-full px-4">
            <div class="flex justify-center  mb-10 pt-10 lg:pt-20 mx-5 lg:mx-96">
                <span class="text-3xl lg:text-4xl font-bold text-center text-white" x-text="infocontent.title.data">We love to make perfect solutions for your
                    business</span>
            </div>
            <div class="flex justify-center mb-10 mx-5 lg:mx-96">
                <span class="text-center text-white text-sm lg:text-base" x-text="infocontent.description.data"> Why I say old chap that is, spiffing off his nut cor blimey
