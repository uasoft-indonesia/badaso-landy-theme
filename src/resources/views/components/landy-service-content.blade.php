 <div class="bg-white">
     <div class="container lg:mx-auto max-w-[1280px] w-full pb-20 pt-10">
         ...
         <div class="flex justify-center mb-5">
             <span class="text-4xl font-bold text-center">Our Best Services</span>
         </div>
         <div class="flex justify-center mb-10 lg:mx-96">
             <span class="text-center text-base text-gray-500 ">There are many variations of passages of Lorem Ipsum
                 available, but the
                 majority have suffered
                 alteration in some form.</span>
         </div>
         <div class="grid lg:grid-cols-12 auto-rows-auto gap-6">
