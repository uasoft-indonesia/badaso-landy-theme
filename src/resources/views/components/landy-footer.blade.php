                        ...
                        <form x-data="subscribe()" x-on:submit.prevent="submitemail()">
                            <div class="">
                                <div class="input-group">
                                    <input type="email" placeholder="Email address" x-model="formData.email" name="email"
                                        class="input input-bordered w-full pr-16" />
                                    <button class="btn btn-square bg-blue-700 hover:bg-blue-800" :disabled="loading">
