...
const config = {
    ...
    projectName: "badaso-landy-theme", // Usually your repo name.
    trailingSlash: false,
    ...
    /** @type {import('@docusaurus/preset-classic').ThemeConfig} */
        ({
        navbar: {
            title: "Badaso Landy Theme",
            logo: {
                alt: "Badaso Landy Theme Logo",
            ...
            items: [
                ...
                {
                    href: "https://github.com/uasoft-indonesia/badaso-landy-theme",
                    label: "GitHub",
                    position: "right",
                },
            ],
